...
from sentry_api.resources import ProjectRulesResource, ProjectsResource, TeamsResource, IssuesResource
...
class SentryApi:
    ...
    def issues(self) -> IssuesResource:
        return IssuesResource(self.organization_slug, self.http_client)
